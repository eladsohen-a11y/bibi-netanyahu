...
לכל תשובה בחר mood שמתאים לטון: proud (גאה), sly (ערמומי/מתחכם), accusing (מאשים את השואל), angry (זועם), defiant (מתריס), emotional (רגשני), suspicious (חשדן), dodging (מתחמק), nervous-smile (חיוך עצבני/לחוץ), answering (עונה בביטחון).`;
